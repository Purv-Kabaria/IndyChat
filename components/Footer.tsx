      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="mb-8">
          ...
          <ul className="list-none">
            ...
            <li className="mb-3">
              <Link href="/about" className="text-[#ddd] no-underline transition-all duration-300 inline-block hover:text-accent hover:translate-x-[5px]">
                About Us
              </Link>
            </li>
            <li className="mb-3">
              <Link href="/contact" className="text-[#ddd] no-underline transition-all duration-300 inline-block hover:text-accent hover:translate-x-[5px]">
                Contact
              </Link>
            </li>
          </ul>
        ...
        <div className="mb-8">
          ...
          <ul className="list-none">
            <li className="mb-3">
              <Link href="/faq" className="text-[#ddd] no-underline transition-all duration-300 inline-block hover:text-accent hover:translate-x-[5px]">
                FAQ
              </Link>
            </li>
            <li className="mb-3">
              <Link href="/privacy" className="text-[#ddd] no-underline transition-all duration-300 inline-block hover:text-accent hover:translate-x-[5px]">
                Privacy Policy
              </Link>
            </li>
            <li className="mb-3">
              <Link href="/terms" className="text-[#ddd] no-underline transition-all duration-300 inline-block hover:text-accent hover:translate-x-[5px]">
                Terms of Service
              </Link>
            </li>
            <li className="mb-3">
              <Link href="/accessibility" className="text-[#ddd] no-underline transition-all duration-300 inline-block hover:text-accent hover:translate-x-[5px]">
                Accessibility
              </Link>
            </li>
            <li className="mb-3">
              <Link href="/support" className="text-[#ddd] no-underline transition-all duration-300 inline-block hover:text-accent hover:translate-x-[5px]">
                Support
              </Link>
            </li>
            <li className="mb-3">
              <Link href="/blog" className="text-[#ddd] no-underline transition-all duration-300 inline-block hover:text-accent hover:translate-x-[5px]">
                Blog
              </Link>
            </li>
          </ul>
