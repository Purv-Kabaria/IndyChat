    ...
    <nav className="py-4 px-8 bg-white w-full border-b border-gray-100 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden lg:flex items-center space-x-4">
          <Link 
            href="/login" 
            className="px-8 py-3 border border-blue-950 rounded-md text-accent hover:bg-accent/10 text-black"
          >
            Login
          </Link>
          <Link 
            href="/signup" 
            className="px-8 py-3 bg-blue-950 text-white rounded-md hover:bg-accent/80"
          >
            Sign Up
          </Link>
        </div>
